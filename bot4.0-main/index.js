...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Dark\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5585988224016:+55 8598822-4016\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD EDU BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Edu. Registre-se para fazer amizade com o bot Dark por meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar Dark|17\n\n──「 Dark BOT 」──`,
			...
			const ownerNumber = ["5585988224016@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5585988224016@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5585988224016@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5585988224016@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5585988224016@s.whatsapp.net","5585984174459@s.whatsapp.net"]
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('85988224016')) return reply('Falha ao ligar para o número do bot')
                                       if (args[0].startsWith('85988224016')) return reply('Falha ao ligar para o número do proprietário')
